...
/*
  ...
  REQUEST SAMPLE
  CHATWORK_URL=https://api.chatwork.com
  ROOM_ID=$1
  MESSAGE_BODY=$2
  MESSAGE="[info][title]Notification[/title]${MESSAGE_BODY}[/info]"
  ENDPOINT_URL=$CHATWORK_URL/v1/rooms/$ROOM_ID/messages
  curl -X POST -H "X-ChatWorkToken: $CHATWORK_TOKEN" --data-urlencode "body=$MESSAGE" "$ENDPOINT_URL"
